...
.tag-card { position:relative; display:grid; grid-template-columns:190rpx minmax(0,1fr) 126rpx; align-items:center; column-gap:16rpx; width:100%; min-height:158rpx; margin-bottom:10rpx; padding:22rpx 18rpx 22rpx 24rpx; overflow:visible; background:transparent; transition:transform .2s ease,filter .2s ease; }
...
.tag-card__name { font-family:"KaiTi","STKaiti","LXGW WenKai Screen",sans-serif; font-size:clamp(12px,21rpx,19px); font-weight:700; line-height:1.2; }
...
.tag-card__title { font-family:"KaiTi","STKaiti","LXGW WenKai Screen",sans-serif; font-size:clamp(14px,25rpx,23px); font-weight:700; line-height:1.22; letter-spacing:1rpx; }
...
@media (max-width:430px) {
  .tag-card { grid-template-columns:98px minmax(0,1fr) 68px; column-gap:7px; min-height:116px; margin-bottom:6px; padding:14px 9px 14px 12px; }
  .tag-card__body { padding:0; }
  .tag-card__labels { gap:4px; margin-top:6px; }
  .tag-card__labels text { padding:2px 4px; }
  .tag-card__cta { width:66px; height:34px; border-width:1px; font-size:10px; line-height:32px; }
}
